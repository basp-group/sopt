...
namespace {
  ...
  template<class T0, class T1>
    ...
    direct_transform_impl(
        ...
        Eigen::ArrayBase<T1> const& signal, WaveletData const &wavelet
    ) {
...
template<class T0>
  auto direct_transform(
      Eigen::ArrayBase<T0> const &signal, t_uint levels, WaveletData const& wavelet)
