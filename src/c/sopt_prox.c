 ...
 * \param[in] sol Auxiliary vector. Dimension: nx. Memory to be used internally 
 *            and doesn't need to be initialized.
 * \param[in] u Auxiliary vector. Dimension: nr. Memory to be used 
 *            internally and doesn't need to be initialized.
 * \param[in] v Auxiliary vector. Dimension: nr. Memory to be used 
 *            internally and doesn't need to be initialized.
 */
